...
foreach ($marker in @("foundationVersion = '0.35-alpha9-knowledge-portability'", 'databaseSchema = 52', 'lanCapabilityGeneration = 41', 'remoteClientMigrated = $true', 'encryptedRemoteCache = $true', 'automaticReconnect = $true', 'remotePlaybackMigrated = $true')) {

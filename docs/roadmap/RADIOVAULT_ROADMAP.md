...
- Continue splitting `LocalWebServer`; playback/queue, federation/administration, client and media route groups, static web assets, and HTTP request/response infrastructure are extracted, leaving general API dispatch as the next boundary.

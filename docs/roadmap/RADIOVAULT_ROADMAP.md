...
- Continue cancellation/timeout policy at external-process, network and media boundaries; transcription downloads now use renewable header/read inactivity deadlines with distinct caller cancellation and partial-file cleanup.

...
|---|---|---|---|
| P1 | Web server | `LocalWebServer.cs` began at 10,436 lines. Player handoff/playback/queue, federation/administration, client API and media routing now live in focused partials, while the web client, service worker and secure setup page are embedded resource files. The main coordinator is 1,972 lines. | Continue separating general API dispatch and shared HTTP infrastructure while preserving dispatcher order, routes, range handling and protocol models. |

...
| P1 | Mobile session | `MobileClientSession.cs` is 3,118 lines and owns pairing, cache, sync, playback, downloads, Explore, Knowledge, offline mutations and UI projection. | Extract sync, playback, download and Explore coordinators, keeping the session as a façade. |
